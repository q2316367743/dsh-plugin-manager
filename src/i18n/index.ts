/**
 * 轻量 i18n：zh/en 字典 + 全局语言状态（dbStorage 持久化）。
 */
...
const stored = KeyValueUtil.getItem<Lang>(LocalNameEnum.KEY_APP_LANG)
const state = reactive<{ lang: Lang }>({ lang: stored === 'en' ? 'en' : 'zh' })
...
export function useI18n() {
  ...
  function setLang(lang: Lang) {
    state.lang = lang
    KeyValueUtil.setItem(LocalNameEnum.KEY_APP_LANG, lang)
  }
